...
describe ApplicationHelper do
  ...
  describe "#handle qualifiers2" do
    it "returns true" do
      options = Hash.new
      options[:value] = ["Last, First, 1600-1700"]
      options[:document] = {}
      options[:document][:loc_naf_author_ss] = ["Last, First, 1600-1700"]
      options[:document][:display_author_ss] = ["First Last, 1600-1700"]
      options[:document][:attrib_qual_ss] = ["--"]
      expect(helper.handle_qualifiers2(options)).to be == "<a href=\"/?f[loc_naf_author_ss][]=Last, First, 1600-1700\">First Last, 1600-1700</a>"
    end
  end
  ...
  describe "#render_aeon_from_access" do
    it "returns true" do
      ...
      expect(helper.render_aeon_from_access(options)).to start_with "<b>On view in the galleries</b>"

      #rb
      options[:value] = ["Accessible by appointment in the Study Room"]
      options[:document] = document2
      options[:document][:detailed_onview_ss] = ["Accessible by appointment in the Study Room"]
      ...
      expect(helper.render_aeon_from_access(options)).to start_with "<b>Accessible by appointment in the Study Room"

      #ref
      #possible to do, need to mock full ref doc?
      options[:value] = ["Accessible by appointment in the Reference Library"]
      options[:document][:detailed_onview_ss] = ["Accessible by appointment in the Reference Library"]
      expect(helper.render_aeon_from_access(options)).to start_with "<b>Accessible by appointment in the Reference Library"

      #pd
      options[:value] = ["Not on view"]
      options[:document] = document4
      options[:document][:detailed_onview_ss] = ["Not on view"]
      expect(helper.render_aeon_from_access(options)).to start_with "<b>Not on view"
  ...
  describe "#render_aeon_from_access_callnumber" do
    it "returns true" do
      expect(helper.render_aeon_from_access_callnumber(document2.deep_symbolize_keys,"bacrb","Folio C 2014 4",9799201)). to start_with "<b>View by request in the Study Room"
      expect(helper.render_aeon_from_access_callnumber(document2.deep_symbolize_keys,"bacref","Folio C 2014 4",9799201)). to start_with "<b>Accessible in the Reference Library"
      expect(helper.render_aeon_from_access_callnumber(document2.deep_symbolize_keys,"bacia","Folio C 2014 4",9799201)). to start_with "<b>Accessible by appointment in the Study Room"
    end
  end
  ...
  describe "#link_to_author" do
    it "returns true" do
      options = Hash.new
      options[:document] = {}
      options[:document][:loc_naf_author_ss] = ["Ireland, Samuel, -1800"]
      options[:value] = ["Ireland, Samuel, -1800"]
      options[:field] = "loc_naf_author_acc"
      expect(helper.link_to_author(options)).to be == "<a href=\"/?f[loc_naf_author_ss][]=Ireland, Samuel, -1800\">Ireland, Samuel, -1800</a>"
    end
  end
    ...
    describe "#render_exhibitions_tab" do
      it "returns true" do
        ...
        document["exhibition_history_ss"] = [
            ...
            "The Critique of Reason : Romantic Art, 1760–1860 (Yale University Art Gallery, 2015-03-06 - 2015-07-26)",
            "An American's Passion for British Art - Paul Mellon's Legacy (Royal Academy of Arts, 2007-10-20 - 2008-01-27)"]
        expect(helper.render_exhibitions_tab(document)).to be == "<p>Yale University Art Gallery 2015 - 2016 (Yale University Art Gallery, 2015-07-27 - 2015-01-05) <span style=\"white-space:nowrap\">[<a href=\"/?f[exhibition_history_ss][]=Yale+University+Art+Gallery+2015+-+2016+%28Yale+University+Art+Gallery%2C+2015-07-27+-+2015-01-05%29\" target='_blank'>YCBA Objects in the Exhibition</a>]</span></p><p>The Critique of Reason : Romantic Art, 1760–1860 (Yale University Art Gallery, 2015-03-06 - 2015-07-26) <span style=\"white-space:nowrap\">[<a href=\"/?f[exhibition_history_ss][]=The+Critique+of+Reason+%3A+Romantic+Art%2C+1760%E2%80%931860+%28Yale+University+Art+Gallery%2C+2015-03-06+-+2015-07-26%29\" target='_blank'>YCBA Objects in the Exhibition</a>]</span></p><p>An American's Passion for British Art - Paul Mellon's Legacy (Royal Academy of Arts, 2007-10-20 - 2008-01-27) <span style=\"white-space:nowrap\">[<a href=\"/?f[exhibition_history_ss][]=An+American%27s+Passion+for+British+Art+-+Paul+Mellon%27s+Legacy+%28Royal+Academy+of+Arts%2C+2007-10-20+-+2008-01-27%29\" target='_blank'>YCBA Objects in the Exhibition</a>]</span></p>"
        document["exhibitionURL_ss"] = ["https://awesitelink.edu"]
        expect(helper.render_exhibitions_tab(document)).to be == "<p>Yale University Art Gallery 2015 - 2016 (Yale University Art Gallery, 2015-07-27 - 2015-01-05) <span style=\"white-space:nowrap\">[<a href=\"/?f[exhibition_history_ss][]=Yale+University+Art+Gallery+2015+-+2016+%28Yale+University+Art+Gallery%2C+2015-07-27+-+2015-01-05%29\" target='_blank'>YCBA Objects in the Exhibition</a>]</span> <span style=\"white-space:nowrap\">[<a href=\"https://awesitelink.edu\" target='_blank'>Exhibition Description</a>]</span></p><p>The Critique of Reason : Romantic Art, 1760–1860 (Yale University Art Gallery, 2015-03-06 - 2015-07-26) <span style=\"white-space:nowrap\">[<a href=\"/?f[exhibition_history_ss][]=The+Critique+of+Reason+%3A+Romantic+Art%2C+1760%E2%80%931860+%28Yale+University+Art+Gallery%2C+2015-03-06+-+2015-07-26%29\" target='_blank'>YCBA Objects in the Exhibition</a>]</span></p><p>An American's Passion for British Art - Paul Mellon's Legacy (Royal Academy of Arts, 2007-10-20 - 2008-01-27) <span style=\"white-space:nowrap\">[<a href=\"/?f[exhibition_history_ss][]=An+American%27s+Passion+for+British+Art+-+Paul+Mellon%27s+Legacy+%28Royal+Academy+of+Arts%2C+2007-10-20+-+2008-01-27%29\" target='_blank'>YCBA Objects in the Exhibition</a>]</span></p>"
      end
    end
