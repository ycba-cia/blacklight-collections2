...
=end
    ...
    @footeritems = [{text:"1080 Chapel Street<br/>New Haven, Connecticut",
                    ...
                    #{text:"Admission is free",
                     ...
                     #           ["Monday","Closed"]]},
                    #},
                    {link_list:[["Hours and visitor information","#{site}/visitor-guidelines"],
                    ...
                    {title:"Research and Learning",
                     link_list:[["Reference Library","#{site}/reference-library-and-photograph-archive"],
                                ["Study Room","#{site}/study-room"],
                                ["Research initiatives","#{site}/research-initiatives"],
